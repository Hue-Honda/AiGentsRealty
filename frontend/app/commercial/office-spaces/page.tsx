        ...
        <section className="relative pt-32 pb-16 px-6 lg:px-16">
          <div className="max-w-[1600px] mx-auto text-center">
            <div className="inline-flex items-center gap-2 bg-[#00C775]/10 border border-[#00C775]/30 rounded-full px-6 py-2 mb-6">
              ...
              <span className="text-sm font-bold text-[#00C775]">PREMIUM OFFICE SPACES</span>
            </div>
          ...
          <div className="max-w-[1600px] mx-auto">
            <div className="bg-[#0D0D0D]/95 backdrop-blur-2xl border border-[#00C775]/20 rounded-3xl shadow-[0_20px_80px_rgba(0,199,117,0.15)] p-6">
              ...
              <div className="flex flex-wrap items-center gap-3">
                <button className="bg-gradient-to-r from-[#00C775] to-[#00A85D] px-6 py-3 rounded-full font-bold text-white shadow-[0_0_30px_rgba(0,199,117,0.4)] hover:shadow-[0_0_50px_rgba(0,199,117,0.6)] transition-all hover:-translate-y-0.5">
                  <div className="flex items-center gap-2">
                    <Sparkles className="w-5 h-5" />
                    <span>AI Match</span>
                  </div>
                </button>
                <button className="bg-[#00C775]/10 border border-[#00C775]/40 hover:bg-[#00C775]/20 px-6 py-3 rounded-full font-bold text-[#00C775] transition-all">
                  Apply
                </button>
                <button
                    ...
                    <div className="relative h-[360px] overflow-hidden">
                      ...
                      <div className="absolute bottom-0 left-0 right-0 p-6 z-20">
                        ...
                        <div className="flex items-end justify-between">
                          ...
                          <ArrowRight className="w-6 h-6 text-[#F3C440] group-hover:translate-x-1 transition-transform" />
                        </div>
                      </div>
                    </div>
                  </div>
