        ...
        <section className="relative pt-32 pb-16 px-6 lg:px-16">
          <div className="max-w-[1600px] mx-auto text-center">
            <div className="inline-flex items-center gap-2 bg-[#10B981]/10 border border-[#10B981]/30 rounded-full px-6 py-2 mb-6">
              ...
              <span className="text-sm font-bold text-[#10B981]">HIGH-TRAFFIC RETAIL</span>
            </div>
          ...
          <div className="max-w-[1600px] mx-auto">
            <div className="bg-white border border-gray-200 rounded-3xl shadow-lg p-6">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-4">
                <div className="relative group">
                  <select
                    ...
                    className="w-full bg-white border border-gray-300 hover:border-[#10B981] rounded-full px-4 py-3 text-[#0A0A0A] text-sm font-semibold focus:outline-none focus:border-[#10B981] transition-all appearance-none cursor-pointer"
                  >
              ...
              <div className="flex flex-wrap items-center gap-3">
                <button className="bg-gradient-to-r from-[#10B981] to-[#059669] px-6 py-3 rounded-full font-bold text-white shadow-md transition-all hover:-translate-y-0.5 hover:shadow-lg">
                ...
                <button
                  ...
                  className="bg-transparent border border-gray-300 hover:border-gray-400 px-5 py-3 rounded-full font-semibold text-[#0A0A0A] text-sm hover:bg-gray-50 transition-all"
                >
                  <div className="flex items-center gap-2">
                    <X className="w-4 h-4" />
                    <span>Reset</span>
              ...
              <div className="group relative block overflow-hidden rounded-3xl border border-gray-200 hover:border-[#D4AF37] transition-all duration-500 hover:-translate-y-2 shadow-md hover:shadow-lg">
                <div className="relative h-[480px] overflow-hidden">
                  ...
                  <div className="absolute top-6 left-6 z-20">
                    <div className="bg-white/95 backdrop-blur-xl border border-[#D4AF37] rounded-xl px-4 py-2.5 flex items-center gap-2 shadow-md">
                      <Store className="w-5 h-5 text-[#D4AF37]" />
                      <span className="text-sm font-bold text-[#0A0A0A]">{featuredProperty.footfall}</span>
                    </div>
                  </div>
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-10 z-20">
                    ...
                    <div className="flex flex-wrap gap-3 mb-6">
                      <div className="flex items-center gap-2 bg-white/95 backdrop-blur-md border border-gray-200 rounded-lg px-4 py-2 shadow-md">
            ...
            {smallProperties.length > 0 && (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {smallProperties.map((property) => (
                  <div key={property.id} className="group relative block overflow-hidden rounded-2xl border border-gray-200 hover:border-[#10B981] transition-all duration-500 hover:-translate-y-2 shadow-md hover:shadow-lg">
