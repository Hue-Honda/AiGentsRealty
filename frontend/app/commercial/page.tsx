        ...
        <section className="relative pt-32 pb-16 px-6 lg:px-16">
          <div className="max-w-[1600px] mx-auto text-center">
            <div className="inline-flex items-center gap-2 bg-[#00C775]/10 border border-[#00C775]/30 rounded-full px-6 py-2 mb-6">
              ...
              <span className="text-sm font-bold text-[#00C775]">AI-POWERED COMMERCIAL</span>
            </div>
            ...
            <div className="flex flex-wrap justify-center gap-3 mt-8">
              <Link href="/commercial/office-spaces" className="bg-[#0D0D0D]/80 backdrop-blur-xl border border-[#00C775]/30 hover:border-[#00C775]/60 px-5 py-2.5 rounded-full text-sm font-semibold text-white transition-all hover:-translate-y-0.5">
                Office Spaces
              </Link>
              <Link href="/commercial/retail" className="bg-[#0D0D0D]/80 backdrop-blur-xl border border-[#00C775]/30 hover:border-[#00C775]/60 px-5 py-2.5 rounded-full text-sm font-semibold text-white transition-all hover:-translate-y-0.5">
                Retail
              </Link>
              <Link href="/commercial/showrooms" className="bg-[#0D0D0D]/80 backdrop-blur-xl border border-[#00C775]/30 hover:border-[#00C775]/60 px-5 py-2.5 rounded-full text-sm font-semibold text-white transition-all hover:-translate-y-0.5">
                Showrooms
              </Link>
              <Link href="/commercial/warehouses" className="bg-[#0D0D0D]/80 backdrop-blur-xl border border-[#00C775]/30 hover:border-[#00C775]/60 px-5 py-2.5 rounded-full text-sm font-semibold text-white transition-all hover:-translate-y-0.5">
                Warehouses
              </Link>
              <Link href="/commercial/mixed-use" className="bg-[#0D0D0D]/80 backdrop-blur-xl border border-[#00C775]/30 hover:border-[#00C775]/60 px-5 py-2.5 rounded-full text-sm font-semibold text-white transition-all hover:-translate-y-0.5">
                Mixed-Use
              </Link>
            </div>
          </div>
            ...
            <div className="bg-[#0D0D0D]/95 backdrop-blur-2xl border border-[#00C775]/20 rounded-3xl shadow-[0_20px_80px_rgba(0,199,117,0.15)] p-6">
              ...
              <div className="flex flex-wrap items-center gap-3">
                ...
                <div className="ml-auto flex gap-3">
                  <Link href="/commercial/roi-calculator" className="bg-[#F3C440]/10 border border-[#F3C440]/40 hover:bg-[#F3C440]/20 px-4 py-3 rounded-full font-semibold text-[#F3C440] text-sm transition-all flex items-center gap-2">
                    <DollarSign className="w-4 h-4" />
                    <span className="hidden md:inline">ROI Calc</span>
                  </Link>
                  <Link href="/commercial/rental-yield" className="bg-[#F3C440]/10 border border-[#F3C440]/40 hover:bg-[#F3C440]/20 px-4 py-3 rounded-full font-semibold text-[#F3C440] text-sm transition-all flex items-center gap-2">
                    <Percent className="w-4 h-4" />
                    <span className="hidden md:inline">Yield</span>
                  </Link>
                  <Link href="/commercial/market-trends" className="bg-[#F3C440]/10 border border-[#F3C440]/40 hover:bg-[#F3C440]/20 px-4 py-3 rounded-full font-semibold text-[#F3C440] text-sm transition-all flex items-center gap-2">
              ...
              >
                <div className="relative h-[480px] overflow-hidden">
                  ...
                  <div className="absolute top-20 left-6 z-20">
                    <div className="bg-[#00C775]/20 backdrop-blur-xl border border-[#00C775]/50 rounded-lg px-3 py-1.5">
                      <span className="text-xs font-bold text-white">{featuredProperty.type}</span>
                    </div>
                  </div>
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-10 z-20">
                    ...
                    <div className="flex flex-wrap gap-3 mb-6">
                      ...
                      <div className="flex items-center gap-2 bg-white/10 backdrop-blur-md border border-white/20 rounded-lg px-4 py-2">
                        <Percent className="w-4 h-4 text-[#F3C440]" />
                        <span className="text-sm font-semibold text-white">{featuredProperty.rentalYield} Yield</span>
                      </div>
                    </div>
                    ...
                    <div className="relative h-[360px] overflow-hidden">
                      ...
                      <div className="absolute top-4 left-4 z-20">
                        <div className="bg-[#F3C440]/20 backdrop-blur-xl border border-[#F3C440]/40 rounded-lg px-3 py-1.5 flex items-center gap-2">
                          ...
                          <span className="text-xs font-bold text-white">{property.developer}</span>
                        </div>
                      </div>

                      {/* Type Badge */}
                      <div className="absolute top-16 left-4 z-20">
                        <div className="bg-[#00C775]/20 backdrop-blur-xl border border-[#00C775]/40 rounded-lg px-2.5 py-1">
                      ...
                      <div className="absolute bottom-0 left-0 right-0 p-6 z-20">
                        ...
                        <div className="flex flex-wrap gap-2 mb-4">
                          ...
                          <div className="flex items-center gap-1.5 bg-white/10 backdrop-blur-md border border-white/20 rounded-lg px-3 py-1.5">
                            <Percent className="w-3.5 h-3.5 text-[#00C775]" />
                            <span className="text-xs font-semibold text-gray-300">{property.rentalYield}</span>
                          </div>
                        </div>
          ...
          <div className="max-w-[1600px] mx-auto">
            <div className="bg-gradient-to-br from-[#0D0D0D] via-[#0D0D0D] to-[#00C775]/5 backdrop-blur-xl border border-[#00C775]/20 rounded-3xl p-12 text-center">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <Link href="/commercial/business-bay" className="bg-gradient-to-r from-[#00C775] to-[#00A85D] px-8 py-4 rounded-full font-bold text-white shadow-[0_0_30px_rgba(0,199,117,0.4)] hover:shadow-[0_0_50px_rgba(0,199,117,0.6)] transition-all hover:-translate-y-1">
                  Business Bay
                </Link>
                <Link href="/commercial/difc" className="bg-gradient-to-r from-[#F3C440] to-[#D4A936] px-8 py-4 rounded-full font-bold text-black shadow-[0_0_30px_rgba(243,196,64,0.4)] hover:shadow-[0_0_50px_rgba(243,196,64,0.6)] transition-all hover:-translate-y-1">
                  DIFC
                </Link>
                <Link href="/commercial/free-zones" className="bg-[#0D0D0D] border-2 border-[#00C775] px-8 py-4 rounded-full font-bold text-white hover:bg-[#00C775]/10 transition-all hover:-translate-y-1">
                  Free Zones
                </Link>
              </div>
            </div>
