      ...
      <div className={`flex ${featured ? 'flex-col lg:flex-row h-full' : 'flex-col'}`}>
        ...
        <div className={`relative overflow-hidden ${featured ? 'lg:w-1/2 h-64 lg:h-auto' : 'h-48'}`}>
          ...
          <div className="absolute top-4 left-4 flex gap-2">
            {post.trending && (
              <div className="bg-[#D4AF37] text-white px-3 py-1.5 rounded-lg text-xs font-bold flex items-center gap-1.5 shadow-md">
                <TrendingUp className="w-3.5 h-3.5" />
                TRENDING
              </div>
            )}
            {post.featured && !featured && (
              <div className="bg-[#10B981] text-white px-3 py-1.5 rounded-lg text-xs font-bold flex items-center gap-1.5 shadow-md">
          ...
          <div className="absolute bottom-4 left-4">
            <span className={`px-3 py-1.5 rounded-lg text-xs font-bold bg-white shadow-md ${
        ...
        {/* Content */}
        <div className={`flex-1 p-6 ${featured ? 'lg:p-8 flex flex-col justify-center' : ''}`}>
          <h3 className={`font-black text-[#0A0A0A] mb-3 leading-tight group-hover:text-[#10B981] transition-colors ${
        ...
        <section className="relative pt-32 pb-16 px-6 lg:px-16">
          <div className="max-w-[1600px] mx-auto">
            ...
            <div className="text-center mb-12">
              <div className="inline-flex items-center gap-2 bg-emerald-100 border border-[#10B981] rounded-full px-6 py-2 mb-6">
                <Sparkles className="w-4 h-4 text-[#10B981]" />
                <span className="text-sm font-bold text-[#10B981]">AI-POWERED INSIGHTS</span>
              </div>

              <h1 className="text-5xl lg:text-7xl font-black text-[#0A0A0A] mb-6 leading-[1.05] tracking-tight">
                Dubai Property
                <br />
              ...
              <div className="flex-1">
                ...
                <div className="flex flex-col sm:flex-row gap-4 mb-8">
                  ...
                  <div className="relative flex-1">
                    ...
                    <input
                      ...
                      className="w-full bg-[#F9FAFB] border-2 border-gray-200 rounded-2xl pl-12 pr-4 py-3.5 text-[#0A0A0A] placeholder-gray-500 focus:outline-none focus:border-[#10B981] transition-all"
                    />
                  </div>
                  ...
                  <div className="relative">
                    ...
                    <select
                      ...
                      className="appearance-none bg-[#F9FAFB] border-2 border-gray-200 rounded-2xl pl-12 pr-12 py-3.5 text-[#0A0A0A] focus:outline-none focus:border-[#10B981] transition-all cursor-pointer"
                    >
                  ...
                  <button
                    ...
                    className={`px-5 py-2.5 rounded-full text-sm font-semibold transition-all ${
                      selectedCategory === 'all'
                        ...
                        : 'bg-white border border-gray-200 text-[#0A0A0A] hover:border-[#10B981] shadow-sm'
                    }`}
                  >
                    All Posts
                  </button>
                ...
                <div className="mb-6">
                  <p className="text-gray-600">
                    Showing <span className="text-[#0A0A0A] font-bold">{filteredPosts.length}</span>{' '}
                ...
                {filteredPosts.length > 0 ? (
                  ...
                  <div className="text-center py-16 bg-white rounded-3xl border border-gray-200 shadow-md">
                    ...
                    <h3 className="text-xl font-bold text-[#0A0A0A] mb-2">No articles found</h3>
                    <p className="text-gray-600">
              ...
              <div className="lg:w-[380px] space-y-8">
                ...
                <div className="bg-white border border-gray-200 shadow-md rounded-3xl p-6">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h3 className="text-xl font-black text-[#0A0A0A]">Trending Now</h3>
                  </div>
                  <div className="space-y-4">
                    {trendingPosts.map((post, index) => (
                      <Link
                        key={post.slug}
                        href={`/blogs/${post.slug}`}
                        className="group flex gap-4 p-3 rounded-xl hover:bg-gray-50 transition-all"
                      >
                        <div className="w-10 h-10 rounded-lg bg-amber-50 border border-[#D4AF37] flex items-center justify-center shrink-0">
                          <span className="text-[#D4AF37] font-black">{index + 1}</span>
                        </div>
                        <div>
                          <h4 className="text-sm font-bold text-[#0A0A0A] group-hover:text-[#10B981] transition-colors line-clamp-2">
                            {post.title}
                          </h4>
                ...
                {/* Categories */}
                <div className="bg-white border border-gray-200 shadow-md rounded-3xl p-6">
                  <h3 className="text-xl font-black text-[#0A0A0A] mb-6">Categories</h3>
                      ...
                      return (
                        <button
                          ...
                          className={`w-full flex items-center justify-between p-3 rounded-xl transition-all ${
                            selectedCategory === category.slug
                              ? 'bg-emerald-50 border border-[#10B981]'
                ...
                {/* Popular Tags */}
                <div className="bg-white border border-gray-200 shadow-md rounded-3xl p-6">
                  <h3 className="text-xl font-black text-[#0A0A0A] mb-6">Popular Tags</h3>
                ...
                {/* CTA Card */}
                <div className="bg-gradient-to-br from-emerald-50 to-white border border-[#10B981] rounded-3xl p-6 text-center shadow-md">
                  <div className="w-16 h-16 bg-emerald-100 rounded-2xl flex items-center justify-center mx-auto mb-4">
                    <Sparkles className="w-8 h-8 text-[#10B981]" />
                  </div>
                  <h3 className="text-xl font-black text-[#0A0A0A] mb-2">Ask Genie AI</h3>
                  <p className="text-sm text-gray-600 mb-4">
                    Get personalized investment advice from our AI property advisor
                  </p>
                  <Link
                    href="/genie"
                    className="inline-flex items-center gap-2 bg-[#10B981] text-white px-6 py-3 rounded-full font-bold hover:shadow-lg transition-all hover:-translate-y-1"
                  >
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-amber-50 flex items-center justify-center">
      <div className="text-center">
        <div className="w-16 h-16 border-4 border-emerald-200 border-t-[#10B981] rounded-full animate-spin mx-auto mb-4" />
