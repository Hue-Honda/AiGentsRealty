        ...
        <section className="px-6 lg:px-16 pb-20">
          <div className="max-w-[1600px] mx-auto space-y-6">
            ...
            {filteredProjects.length === 0 ? (
              ...
              <>
                {/* Featured and other project cards - keeping the same layout as before */}
                {featuredProject && (
                  <Link
                ...
                {/* Medium and small projects grids remain the same... */}
                {mediumProjects.length > 0 && (
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    {mediumProjects.map((project) => (
                      ...
                      >
                        {/* Medium project card content - keeping original */}
                ...
                {/* Small projects and remaining projects grids - keeping original code structure */}
