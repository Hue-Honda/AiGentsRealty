        ...
        <section className="relative pt-32 pb-16 px-6 lg:px-16">
          <div className="max-w-[1600px] mx-auto text-center">
            <div className="inline-flex items-center gap-2 bg-[#00C775]/10 border border-[#00C775]/30 rounded-full px-6 py-2 mb-6">
              ...
              <span className="text-sm font-bold text-[#00C775]">EXPLORE COMMUNITIES</span>
            </div>
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className={`flex-1 flex items-center justify-center gap-2 px-4 py-3 rounded-full font-semibold text-sm transition-all ${
                      viewMode === 'grid'
                        ? 'bg-[#00C775] text-black shadow-[0_0_20px_rgba(0,199,117,0.4)]'
                        : 'bg-[#0D0D0D] border border-[#00C775]/20 text-white hover:border-[#00C775]/50'
                    }`}
                  >
                  ...
                  <button
                    ...
                    className={`flex-1 flex items-center justify-center gap-2 px-4 py-3 rounded-full font-semibold text-sm transition-all ${
                      viewMode === 'map'
                        ? 'bg-[#F3C440] text-black shadow-[0_0_20px_rgba(243,196,64,0.4)]'
                        : 'bg-[#0D0D0D] border border-[#F3C440]/20 text-white hover:border-[#F3C440]/50'
                    }`}
                  >
                  ...
                  <div className="relative h-[400px] overflow-hidden">
                    ...
                    <div className="absolute top-4 left-4 right-4 z-20 flex flex-wrap gap-2">
                      {community.lifestyle.map((tag) => (
                        <div
                          key={tag}
                          className="bg-[#F3C440]/20 backdrop-blur-xl border border-[#F3C440]/50 rounded-lg px-3 py-1.5"
                        >
                    ...
                    <div className="absolute top-4 right-4 z-20">
                      <div className="bg-[#00C775]/20 backdrop-blur-xl border border-[#00C775]/50 rounded-xl px-3 py-2 flex items-center gap-2">
                        <Home className="w-4 h-4 text-[#00C775]" />
                        <span className="text-sm font-bold text-white">{community.amenities} Amenities</span>
                      </div>
                    </div>

                    {/* Content - Bottom */}
                    <div className="absolute bottom-0 left-0 right-0 p-6 z-20">
                      <h2 className="text-3xl font-black text-white mb-2 leading-tight group-hover:text-[#00C775] transition-colors">
                        {community.name}
                      </h2>

                      <div className="flex items-center gap-2 mb-3">
                        <MapPin className="w-4 h-4 text-[#F3C440]" />
                        <span className="text-sm font-semibold text-gray-300">{community.location}</span>
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-2xl font-black bg-gradient-to-r from-[#00C775] via-[#00D97E] to-[#00C775] bg-clip-text text-transparent">
                            {community.priceFrom}
                          </p>
                        </div>
                        ...
                        <div className="flex items-center gap-2 text-[#F3C440] font-bold group-hover:gap-3 transition-all">
                          ...
                          <div className="w-10 h-10 rounded-full border-2 border-[#F3C440] flex items-center justify-center group-hover:bg-[#F3C440] group-hover:text-black transition-all">
          ...
          <div className="max-w-[1600px] mx-auto">
            <div className="bg-gradient-to-br from-[#0D0D0D] via-[#0D0D0D] to-[#00C775]/5 backdrop-blur-xl border border-[#00C775]/20 rounded-3xl p-12 text-center">
              ...
              <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                <div className="bg-[#0D0D0D]/80 backdrop-blur-xl border border-[#00C775]/30 hover:border-[#00C775]/60 p-6 rounded-2xl transition-all hover:-translate-y-1 cursor-pointer group">
                  <Users className="w-8 h-8 text-[#00C775] mx-auto mb-3 group-hover:scale-110 transition-transform" />
                  <p className="font-bold text-white">Family</p>
                </div>
                <div className="bg-[#0D0D0D]/80 backdrop-blur-xl border border-[#F3C440]/30 hover:border-[#F3C440]/60 p-6 rounded-2xl transition-all hover:-translate-y-1 cursor-pointer group">
                  <Palmtree className="w-8 h-8 text-[#F3C440] mx-auto mb-3 group-hover:scale-110 transition-transform" />
                  <p className="font-bold text-white">Waterfront</p>
                </div>
                <div className="bg-[#0D0D0D]/80 backdrop-blur-xl border border-[#00C775]/30 hover:border-[#00C775]/60 p-6 rounded-2xl transition-all hover:-translate-y-1 cursor-pointer group">
                  <Golf className="w-8 h-8 text-[#00C775] mx-auto mb-3 group-hover:scale-110 transition-transform" />
                  <p className="font-bold text-white">Golf</p>
                </div>
                <div className="bg-[#0D0D0D]/80 backdrop-blur-xl border border-[#F3C440]/30 hover:border-[#F3C440]/60 p-6 rounded-2xl transition-all hover:-translate-y-1 cursor-pointer group">
                  <Building2 className="w-8 h-8 text-[#F3C440] mx-auto mb-3 group-hover:scale-110 transition-transform" />
                  <p className="font-bold text-white">Urban</p>
                </div>
                <div className="bg-[#0D0D0D]/80 backdrop-blur-xl border border-[#00C775]/30 hover:border-[#00C775]/60 p-6 rounded-2xl transition-all hover:-translate-y-1 cursor-pointer group">
                  <Heart className="w-8 h-8 text-[#00C775] mx-auto mb-3 group-hover:scale-110 transition-transform" />
                  <p className="font-bold text-white">Luxury</p>
                </div>
              </div>
            </div>
          </div>
